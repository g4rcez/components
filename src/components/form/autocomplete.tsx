...
export const Autocomplete = forwardRef<HTMLInputElement, AutocompleteProps>(
    ({ options, dynamicOption = false, feedback = null, labelClassName, interactive, rightLabel, optionalText, container, hideLeft = false, right, left, error, required = false, ...props }: AutocompleteProps, externalRef) => {
        ...
        return (
            ...
            >
                ...
                <input
                    ...
                    autoComplete="off"
                    className={css(
                        "input text-foreground text-base group h-11 w-full flex-1 rounded-md bg-transparent p-2 placeholder-input-mask outline-none transition-colors group-error:text-danger group-error:placeholder-input-mask-error",
                        !!right || shadow ? "pe-12" : "",
                        !!left ? "ps-8" : "",
                        props.className
                    )}
