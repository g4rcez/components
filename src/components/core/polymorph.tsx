...
export type Props<T extends React.ElementType = React.ElementType> =
  Polymorphism<T> & Omit<React.ComponentPropsWithRef<T>, keyof Polymorphism<T>>;
...
>({ as, ...props }: Props<T>, ref: React.ForwardedRef<any>) {
