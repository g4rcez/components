                ...
                <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
                    ...
                    <div className="lg:col-span-1">
                        ...
                        <p className="mt-4 text-sm text-foreground/70">
                            A comprehensive React component library built with TypeScript, Tailwind CSS, and modern web technologies.
                        </p>
                        <div className="mt-6 flex items-center gap-4">
                            <a target="_blank" rel="noopener noreferrer" className="transition-colors" href="https://github.com/g4rcez/components">
                    ...
                    {Object.entries(footerLinks).map(([category, links]) => (
                        <div key={category}>
                            <h3 className="mb-4 text-base font-medium tracking-wide text-foreground">{category}</h3>
