...
export const sections: Section[] = [
    {
        ...
        items: [
            ...
            { title: "Installation", href: "/docs/get-started", icon: RocketIcon },
            {
                title: "Theme Setup",
                href: "/docs/setup",
                icon: GearIcon,
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Buttons", href: "/docs/buttons", icon: CursorIcon },
            {
                title: "Button Group",
            ...
            { title: "Tags", href: "/docs/tags", icon: TagIcon },
    ...
    },
    {
        ...
        items: [
            ...
            { title: "Modal", href: "/docs/modal", icon: SquareIcon },
    ...
    },
    {
        title: "Utilities",
        icon: GearIcon,
        items: [{ title: "RenderOnView", href: "/docs/render-on-view", icon: EyeIcon }],
    },
];
