...
export default function StepperPage() {
    ...
    return (
        <DocsLayout title="Steps" section="display" description="Visualizes progress through a multi-step process with an interactive stepper.">
            <ComponentDemo
        ...
        <Button onClick={() => setStep(step > totalSteps ? step : step + 1)}>
          Continue
            ...
            >
                <Card
                    title={
                        <Steps steps={4} currentStep={step}>
                            ...
                            <Step step={2} title="Second" onClick={onClick} currentStep={step} />
                ...
                >
                    {step < 5 ? <div className="p-32 text-center">Step {step}</div> : <div className="p-32 text-center">Finish him!</div>}
                    <div className="flex flex-row justify-between">
                        <Button theme="neutral" onClick={() => setStep(step < 2 ? step : step - 1)}>
                            Back
                        </Button>
                        <Button onClick={() => setStep(step > 4 ? step : step + 1)}>Continue</Button>
                    </div>
                </Card>
            </ComponentDemo>
        </DocsLayout>
