...
const ConfirmationDialog = () => {
    ...
    return <Button onClick={onClick}>Start confirmed cycle: {confirmed.toString()}</Button>;
};
...
const DialogDemo = () => {
    ...
    return (
        <div className="flex flex-row flex-wrap gap-6">
            ...
            <Modal closable overlayClickClose type="dialog" title="Dialog" open={open} onChange={setOpen}>
                {Array.from({ length: 10 }).map((_, i) => (
                    <span key={uuid()}>
                ...
                <Tooltip title={<b>Test</b>}>
                    <div className="flex min-w-full flex-1">Paullum deliquit, ponderibus modulisque suis ratio utitur.</div>
                </Tooltip>
            </Modal>
        </div>
    );
...
const DrawerLeftDemo = () => {
    ...
    return (
        <div className="flex flex-row flex-wrap gap-6">
            ...
            <Modal closable overlayClickClose type="drawer" position="left" title="Drawer from left" open={open} onChange={setOpen}>
...
const DrawerRightDemo = () => {
    ...
    return (
        <div className="flex flex-row flex-wrap gap-6">
            ...
            <Modal closable overlayClickClose type="drawer" position="right" title="Drawer from right" open={open} onChange={setOpen}>
...
const SheetDemo = () => {
    ...
    return (
        <div className="flex flex-col gap-6">
            <p>
                Bottom Sheet or just Sheet it&apos;s a component that opens from bottom to top. It&apos;s very useful for mobile apps. That&apos;s why
                dialog and drawer are changed to sheet on mobile.
            </p>
