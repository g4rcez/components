  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      />
            ...
            >
                <Card title="Brazilian masks" className="grid grid-cols-1 gap-6 md:grid-cols-3">
                    <Input mask="cpf" title="CPF" placeholder="000.000.000-00" required />
                    <Input
                        mask="cnpj"
                        title="CNPJ"
                    ...
                    />
                    <Input mask="cellphone" title="Cellphone" placeholder="(99) 99999-9999" required />
                </Card>
            </ComponentDemo>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
      ...
      />
            ...
            >
                <Card title="Custom masks" className="grid grid-cols-1 gap-6 md:grid-cols-3" container="mt-6">
                    <Input info="Pattern: 3 numbers + Space + 3 letters" mask="ddd AAA" title="Custom" placeholder="000 ZZZ" required />
                    <Input mask="int" title="Integer" placeholder="123" required />
                    <Input info="Input disabled" title="Disabled" disabled defaultValue="000" placeholder="disabled" required />
