...
export default function ExpandPage() {
    return (
        <DocsLayout title="Expand" section="Floating" description="A button that expands into a floating content area.">
            <ComponentDemo
          ...
          <Tag indicator="success" theme="neutral">
            ...
            >
                <Card title="Simple with popover">
                    ...
                    >
                        <div className="flex w-[200px] flex-col items-center justify-center gap-4 rounded-lg border border-card-border bg-card-background p-8 shadow-lg">
                            Cras mattis iudicium purus sit amet fermentum. Curabitur blandit tempus ardua ridiculus sed magna.
                            <Tag>Tags</Tag>
                            <Tag indicator="success" theme="neutral">
                                Tags
                            </Tag>
