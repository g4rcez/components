...
export default function FilterBarPage() {
    return (
        <DocsLayout title="Filter Bar" section="display" description="A flexible filter bar component to refine data displays.">
            <ComponentDemo
            ...
            >
                <Card>
                    <div className="flex flex-nowrap items-end gap-4">
                        ...
                        >
                            <div className="flex flex-col gap-4">
                                <DatePicker floating={false} required placeholder="Today" title="Date" />
                            </div>
                        </Tooltip>
                        <Tooltip
                            hover={false}
