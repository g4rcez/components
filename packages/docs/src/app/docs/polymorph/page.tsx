            ...
            >
                <Card title="As different elements">
                    <div className="flex flex-col gap-4">
                        ...
                        <Polymorph as="section" className="rounded border border-card-border p-4">
                            Section block
                        </Polymorph>
                    </div>
                </Card>
            ...
            >
                <Card title="As button">
                    <div className="flex gap-4">
                        ...
                        <Polymorph as="button" type="button" disabled className="rounded bg-muted px-4 py-2 text-disabled">
                            Disabled
                        </Polymorph>
                    </div>
                </Card>
