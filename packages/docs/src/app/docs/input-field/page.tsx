...
import { Card, InputField } from "@g4rcez/components";
  ...
  return (
    <InputField name="username" title="Username" placeholder="Enter username" required>
      <input
        ...
        className="input h-input-height w-full flex-1 rounded-input-radius bg-transparent px-input-padding-x py-input-padding-y text-input-text text-foreground outline-none"
      />
    </InputField>
  );
}`}
        ...
        />
            ...
            >
                <Card title="Error & info">
                    <div className="flex flex-col gap-4">
                        <InputField name="email" title="Email" error="Please enter a valid email address." required>
                            <input
                                id="email"
                                name="email"
                                type="email"
                        ...
                        <InputField name="api-key" title="API Key" info="Generate a key from your account settings." required>
                            <input
                                id="api-key"
                                name="api-key"
                                type="password"
