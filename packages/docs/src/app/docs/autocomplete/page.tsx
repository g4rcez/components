    ...
    return (
        <Fragment>
            <Modal open={open} onChange={setOpen} title="Select on modal">
                <Autocomplete id="select-on-modal" rightLabel=" " title="One option" options={defaults} />
            </Modal>
  ...
  return (
    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
      ...
      />
            ...
            >
                <div className="grid grid-cols-1 gap-6 md:grid-cols-2">
                    <Autocomplete id="1" options={[]} title="Empty" rightLabel=" " emptyMessage="Empty message..." />
                    <Autocomplete id="2" disabled options={[]} rightLabel=" " title="Disabled" emptyMessage="Empty message..." />
                </div>
            </ComponentDemo>
