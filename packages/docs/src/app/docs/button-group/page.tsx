...
export default function ButtonGroup() {
    return (
        <DocsLayout title="Button Group" section="display" description="A simple way to implement button groups.">
            <ComponentDemo
      ...
      <Button theme="muted" className="rounded-r-button" rounded="squared">Button</Button>
            ...
            >
                <Card title="Button Group Example" className="flex flex-wrap gap-8">
                    <div className="flex">
                        <Button theme="muted" className="rounded-l-button" rounded="squared">
                            Merge
                        </Button>
                        <Button theme="primary" rounded="squared">
                            Merge
                        </Button>
                        <Button theme="muted" className="rounded-r-button" rounded="squared">
                            Button
                        </Button>
                    </div>
                </Card>
