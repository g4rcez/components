...
const List = forwardRef(function VirtualList(props: any, ref: any) {
  return (
    <motion.ul {...props} role="listbox" ref={ref as any} className="w-full rounded-b-lg border-b last:border-transparent border-tooltip-border">
            ...
            <FloatingOverlay lockScroll>
              <FloatingFocusManager modal guards returnFocus={false} context={context} initialFocus={-1} visuallyHiddenDismiss>
                <div
                  ...
                  data-floating="true"
                  className="overscroll-contain p-0 m-0 w-full max-h-96 list-none rounded-t-lg rounded-b-lg border shadow-floating isolate z-floating origin-[top_center] border-floating-border bg-floating-background text-foreground"
                >
                  <input
                    autoFocus
                    value={shadow}
                  ...
                  />
                  {isEmpty ? (
                    <li role="option" className="w-full border-b last:border-transparent border-tooltip-border">
