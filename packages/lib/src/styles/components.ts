import type { ComponentTokens } from "./theme.types.ts";

export const components: ComponentTokens = {
    card: {
        rounded: "calc(var(--var-radius, 0px) + calc(var(--var-radius-base) / 4))",
    ...
    button: {
        ...
        "radius-rough": "calc(var(--var-radius, var(--var-radius-base)) / 6)",
        "radius-squared": "0",
        "text-big": "calc(var(--var-fontsize) * 1)",
        "text-icon": "calc(var(--var-spacing-base) * 1)",
    ...
    alert: {
        rounded: "calc(var(--var-radius, calc(var(--var-radius-base) / 2)) - calc(var(--var-radius-base) / 4))",
    ...
    notification: {
        rounded: "calc(var(--var-radius, var(--var-radius-base)) * 1.333333)",
        p: "calc(var(--var-spacing-base) * 1)",
    ...
    skeleton: {
        rounded: "calc(var(--var-radius, var(--var-radius-base)) / 3)",
    ...
    input: {
        "field-icon-size": "calc(var(--var-spacing-base) * 1)",
        "field-small-icon-size": "calc(var(--var-spacing-base) * 0.875)",
        "field-label-row-gap": "calc(var(--var-spacing-base) * 0.25)",
        "field-label-meta-gap": "calc(var(--var-spacing-base) * 0.25)",
        "field-tooltip-icon-size": "calc(var(--var-spacing-base) * 0.75)",
        "field-small-tooltip-icon-size": "calc(var(--var-spacing-base) * 0.6875)",
        ...
        "field-control-radius": "calc(var(--var-radius, var(--var-radius-base)) * 0.375)",
        ...
        "free-text-big-control-height": "calc(var(--var-spacing-base) * 3)",
        "free-text-min-control-height": "calc(var(--var-spacing-base) * 1.75)",
        "free-text-small-control-height": "calc(var(--var-spacing-base) * 2)",
        "free-text-tiny-control-height": "calc(var(--var-spacing-base) * 1.5)",
        "free-text-surface-radius": "calc(var(--var-radius, var(--var-radius-base)) * 0.375)",
        "free-text-surface-padding-inline": "calc(var(--var-spacing-base) * 0.5)",
        "free-text-big-surface-padding-inline": "calc(var(--var-spacing-base) * 1.5)",
        "free-text-min-surface-padding-inline": "calc(var(--var-spacing-base) * 0.75)",
        "free-text-small-surface-padding-inline": "calc(var(--var-spacing-base) * 0.375)",
        "free-text-tiny-surface-padding-inline": "calc(var(--var-spacing-base) * 0.5)",
        ...
        "free-text-big-font-size": "calc(var(--var-fontsize) * 1)",
        "free-text-min-font-size": "calc(var(--var-fontsize) * 0.875)",
        "free-text-small-font-size": "calc(var(--var-fontsize) * 0.875)",
        "free-text-tiny-font-size": "calc(var(--var-fontsize) * 0.875)",
    ...
    progress: {
        "track-h": "calc(var(--var-spacing-base) * 1.5)",
        rounded: "calc(var(--var-radius, var(--var-radius-base)) * 0.4)",
    },
    spinner: {
    ...
    toolbar: {
        ...
        rounded: "calc(var(--var-radius-base) * 0.5)",
        p: "calc(var(--var-spacing-base) / 4)",
    },
    wizard: {
