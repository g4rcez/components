...
export const defaultLightThemeTokens = {
    ...
    components: {
        ...
        tag: {
            ...
            info: {
                background: "var(--var-color-info)",
                foreground: "var(--var-color-info-foreground)",
            },
            warn: {
                background: "var(--var-color-warn)",
                foreground: "var(--var-color-warn-foreground)",
            },
            muted: {
                background: "var(--var-color-muted)",
                foreground: "var(--var-color-muted-foreground)",
            },
            danger: {
                background: "var(--var-color-danger)",
                foreground: "var(--var-color-danger-foreground)",
            },
            success: {
                background: "var(--var-color-success)",
                foreground: "var(--var-color-success-foreground)",
            },
            secondary: {
                background: "var(--var-color-secondary)",
                foreground: "var(--var-color-secondary-foreground)",
            },
            disabled: {
