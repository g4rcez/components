...
export type TableTokens = {
    ...
    "properties-icon-size": string;
    "properties-trigger-min-block-size": string;
    "properties-list-min-inline-size": string;
    "properties-list-gap": string;
    "properties-item-gap": string;
    "properties-handle-padding": string;
    "divider-width": string;
    "resizer-inline-size": string;
    "resizer-block-size": string;
    "resizer-focus-ring-width": string;
    "resizer-focus-ring-offset": string;
...
export type InputTokens = {
    ...
    "free-text-big-control-height": string;
    "free-text-min-control-height": string;
    "free-text-small-control-height": string;
    "free-text-tiny-control-height": string;
    "free-text-surface-radius": string;
    "free-text-surface-padding-inline": string;
    "free-text-big-surface-padding-inline": string;
    "free-text-min-surface-padding-inline": string;
    "free-text-small-surface-padding-inline": string;
    "free-text-tiny-surface-padding-inline": string;
    "free-text-surface-padding-block": string;
    "free-text-small-surface-padding-block": string;
    "free-text-font-size": string;
    "free-text-big-font-size": string;
    "free-text-min-font-size": string;
    "free-text-small-font-size": string;
    "free-text-tiny-font-size": string;
