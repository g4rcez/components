...
export const defaultTranslations = {
    ...
    datePickerAddDate: "Add date",
    datePickerNights: (n: number) => `${n} ${n === 1 ? "night" : "nights"}`,
    ...
    tablePropertiesLabel: "Properties",
    tablePropertiesTitle: "Columns",
    tablePropertiesReorderLabel: (label: string) => `Reorder ${label}. Use the Up and Down arrow keys.`,
