...
| `free-text` | `@g4rcez/components/input.css` | `input-field.css`, `polymorph.css`, `tooltip.css` | `__free-text` | none | none |
...
| `input-field` | `@g4rcez/components/input.css` | `polymorph.css`, `tooltip.css` | `__input-field` | none | `__input-field__feedback-icon`, `__input-field__status-icon`, `__input-field__tooltip-content`, `__input-field__optional-text`, `__input-field__error` |
...
| `page-calendar-day-view` | `@g4rcez/components/page-calendar.css` | `button.css`, `page-calendar-event-pill.css`, `polymorph.css`, `tag.css` | `__page-calendar-day-view` | none | none |
| `page-calendar-event-pill` | `@g4rcez/components/page-calendar.css` | `button.css` | `__page-calendar-event-pill` | none | none |
| `page-calendar-header` | `@g4rcez/components/page-calendar.css` | `button.css`, `polymorph.css`, `tag.css` | `__page-calendar-header` | none | `__page-calendar-header__nav-icon`, `__page-calendar-header__add-icon`, `__page-calendar-header__filter-icon` |
| `page-calendar-month-view` | `@g4rcez/components/page-calendar.css` | `button.css`, `page-calendar-event-pill.css` | `__page-calendar-month-view` | none | none |
| `page-calendar-week-view` | `@g4rcez/components/page-calendar.css` | `button.css`, `page-calendar-event-pill.css` | `__page-calendar-week-view` | none | none |
...
| `table-filter` | `@g4rcez/components/table.css` | `dropdown.css`, `input.css`, `input-field.css`, `polymorph.css`, `select.css`, `tooltip.css` | `__table-filter` | none | `__table-filter__trigger-icon`, `__table-filter__add-icon`, `__table-filter__delete-icon` |
| `table-group` | `@g4rcez/components/table.css` | `button.css`, `dropdown.css`, `input-field.css`, `polymorph.css`, `select.css`, `tooltip.css` | `__table-group` | none | `__table-group__drag-icon`, `__table-group__trigger-icon`, `__table-group__delete-icon` |
| `table-head` | `@g4rcez/components/table.css` | `dropdown.css`, `input.css`, `input-field.css`, `polymorph.css`, `select.css`, `table-filter.css`, `table-sort.css`, `tooltip.css` | `__table-head` | none | `__table-head__filter-icon`, `__table-head__add-icon` |
| `table-inner-table` | `@g4rcez/components/table.css` | `dropdown.css`, `empty.css`, `input.css`, `input-field.css`, `polymorph.css`, `select.css`, `table-filter.css`, `table-head.css`, `table-pagination.css`, `table-row.css`, `table-sort.css`, `tooltip.css` | `__table-inner-table` | none | `__table-inner-table__body`, `__table-inner-table__row` |
| `table-metadata` | `@g4rcez/components/table.css` | `button.css`, `dropdown.css`, `input.css`, `input-field.css`, `polymorph.css`, `select.css`, `table-filter.css`, `table-group.css`, `table-sort.css`, `tooltip.css` | `__table-metadata` | none | none |
| `table-pagination` | `@g4rcez/components/table.css` | `polymorph.css` | `__table-pagination` | none | none |
| `table-root` | `@g4rcez/components/table.css` | `button.css`, `dropdown.css`, `empty.css`, `input.css`, `input-field.css`, `polymorph.css`, `select.css`, `table-filter.css`, `table-group.css`, `table-head.css`, `table-inner-table.css`, `table-metadata.css`, `table-pagination.css`, `table-row.css`, `table-sort.css`, `tooltip.css` | `__table-root` | none | none |
| `table-row` | `@g4rcez/components/table.css` | none | `__table-row` | none | `__table-row__aside`, `__table-row__cell`, `__table-row__cell-content` |
| `table-sort` | `@g4rcez/components/table.css` | `dropdown.css`, `input-field.css`, `polymorph.css`, `select.css`, `tooltip.css` | `__table-sort` | none | `__table-sort__trigger-icon`, `__table-sort__delete-icon`, `__table-sort__add-icon`, `__table-sort__head-icon` |
...
| `textarea` | `@g4rcez/components/input.css` | none | `__textarea` | none | none |
